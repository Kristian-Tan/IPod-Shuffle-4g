...
def main():
    ...
    class Shuffler(object):
        ...
        def write_database(self):
            ...
            print("writing to file: " + os.path.join(self.path, "iPod_Control", "iTunes", "iTunesSD"))
    ...
    if __name__ == '__main__':
        ...
        parser.add_argument('path', help='Path to the IPod\'s root directory', widget='DirChooser')
